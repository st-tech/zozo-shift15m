...
cat ${TASK_ROOT}/set_matching_test_data_splits/set_matching_test_data.tar.gz-* > ${TASK_ROOT}/set_matching_test_data.tar.gz
tar zxvf ${TASK_ROOT}/set_matching_test_data.tar.gz -C ${TASK_ROOT}
