...
from weight_estimation.config import get_trainer_conf, get_model_conf
from weight_estimation.dataset import get_train_val_dataset
...
def main(args):
    ...
    if args.model == "two_layered_cnn":
        from weight_estimation.model import TwoLayeredCNN
