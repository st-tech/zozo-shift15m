...
for k in range(len(models)):
    ...
    for shift in shifts:
        ...
        for i in tqdm.tqdm(range(n_trials)):
            ...
            p_tr = norm.pdf(x_train, loc=shift["train_mu"], scale=shift["train_sigma"])
            p_te = norm.pdf(x_train, loc=test_mu, scale=test_sigma)
...
plt.ylabel("MAE")
plt.savefig("sumprices_regression_iwerm_covariate_shift.png")
plt.show()
